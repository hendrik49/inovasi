...
<div class="row">
  <div class="col-lg-4">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <?php echo form_open('perkembangan/index')?>
        ...
        <table id="example1" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo site_url('perkembangan/index/'.$rows->perkembangan_id)?>" class="btn btn-xs bg-green" data-toggle="tooltip" title="Edit Data"><i class="fa fa-pencil"></i></a>
                <a href="<?php echo site_url('trash/proses?tabel=perkembangan&primary='.$rows->perkembangan_id.'&url=perkembangan')?>" class="btn btn-xs bg-red" data-toggle="tooltip" title="Hapus Data" onclick="return confirm('Menghapus data!! Anda yakin??')"><i class="fa fa-trash-o"></i></a>
              </td>
            </tr>
            <?php
              $no++;
