...
echo form_open_multipart('adm_daftar_acara/edit');
echo form_hidden('id',$item['daftar_acara_id']);
?>
<div class="box">
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_acara" value="<?php echo $item['nama_program']?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('nama_acara', ' ')?></p>
        </div>
        <div class="form-group">
          <label>Hari*</label>
          <input type="text" name="hari" value="<?php echo $item['hari']?>" class="form-control">
          <p class="help-block text-red"><?php echo form_error('hari', ' ')?></p>
        </div>
         <div class="form-group">
          <label>Waktu*</label>
          <input type="text" name="waktu" value="<?php echo $item['waktu']?>" class="form-control">
