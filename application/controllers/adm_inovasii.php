...
*/
class Adm_inovasii extends CI_Controller
{
	...
	//	$id = $this->session->userdata('opd_id');
		$data['title'] = "Inovasi";
		$data['konten'] = 'admin/inovasi/index';
		$link = 'adm_inovasii/index/';
		$limit= 10;
		$uri_segment= 3;
		$offset= $this->uri->segment($uri_segment);
		//$data['list'] = $this->supermodel->getData('album');
		$jum = $this->supermodel->getData('inovasi');
		$data['listview'] = $this->supermodel->getData('inovasi');
	...
	{
		$data['title'] = "Inovasi";
		$data['konten'] = 'admin/inovasi/tambah';
		$link = 'adm_inovasii/tambah/';
		$limit= 10;
		$uri_segment= 3;
		$offset= $this->uri->segment($uri_segment);
		//$data['list'] = $this->supermodel->getData('album');
	...
	function edit($id=null)
	{
		...
		$data['konten'] = 'admin/inovasi/edit';
